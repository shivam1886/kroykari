								...
								@foreach($data['fields'] as $field)
									 ...
									 @if($field->field_type == 'select')
										<div class="col-md-6 col-sm-6">
											<div class="form-group">
												...
												<select name="{{ $field->field_id }}" class="form-control">
									 ...
									 @if($field->field_type == 'text')
										<div class="col-md-6 col-sm-6">
											<div class="form-group">
												<label>{{ __($field->field_name) }}</label>
												<input type="text" name="{{$field->field_id}}" value="{{$field->field_value}}" class="form-control"/>
											</div>
										</div>
									 @endif
									 ...
									 <div class="col-md-6 col-sm-6">
										 <div class="form-group">
											 <label>{{ __($field->field_name) }}</label>
											 @forelse($field->options as $option_key =>  $option)
										    	 <input type="radio" name="{{$field->field_id}}" @if($option->option == $field->field_value) checked @endif value="{{$option->option}}"/>&nbsp;{{__($option->option)}}&nbsp;
											 @empty
											 @endforelse
										 </div>
									 </div>
									 ...
									 <div class="col-md-6 col-sm-6">
										 <div class="form-group">
											 <label>{{ __($field->field_name) }}</label>
											 @forelse($field->options as $option_key =>  $option)
										    	 <input type="checkbox" name="{{$field->field_id}}[]" @if(in_array(strtolower($option->option),json_decode(strtolower($field->field_value)))) checked @endif value="{{$option->option}}"/>&nbsp;{{__($option->option)}}&nbsp;
											 @empty
											 @endforelse
										 </div>
									 </div>
								...
								<div class="row">
									...
									<div class="col-md-4 col-sm-12 col-xs-12">
										<div class="single-plan">
											...
											<div class="body">
												<ul>
													<li>{{__('7 days top rank')}}</li>
													<li>{{__('Lorem Ipsum<')}}/li>
													<li>{{__('7 days top rank copy')}}</li>
												</ul>
												
												<button disabled data-toggle="modal" data-target="#plan-pay">{{__('Choose')}}</button>
											</div>
										</div>
									</div>
									<!--end-->
									...
									<div class="col-md-4 col-sm-12 col-xs-12">
										<div class="single-plan">
											...
											<div class="body">
												<ul>
													<li>{{__('7days top rank')}}</li>
													<li>{{__('Lorem Ipsum')}}</li>
													<li>{{__('7days top rank copy')}}</li>
												</ul>
