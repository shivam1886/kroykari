...
@section('content')
  ...
  <section class="contactus-page padding-top">
    <div class="container">
		...
		<div class="row cts-pd">
            <div class="col-md-6 text-right">
            <div class="call-us"> <i class="fa fa-phone" aria-hidden="true"></i> {{__('Call us') }} : +8801833999485</div>
			</div>
			<div class="col-md-6 text-left">
				<div class="live-chat"> <i class="fa fa-comments" aria-hidden="true"></i><a  target="_blank" href="https://www.facebook.com/kroykari">Live Chat</a></div>
			</div>
